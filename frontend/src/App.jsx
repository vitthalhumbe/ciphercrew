...
export default function App() {
  ...
  .theme-dark {
    --bg-base: #09090b;
    --bg-surface: #18181b; /* Slightly lighter surface for better contrast */
    ...
    --text-muted: #a1a1aa;
    --text-dim: #71717a;
    --accent-red: #fb7185; /* Softened from #f43f5e */
    --accent-yellow: #fbbf24;
    --accent-green: #34d399; /* Softened from #10b981 */
    --accent-blue: #60a5fa;
  }
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .app-root {
    ...
    overflow: hidden;
    -webkit-font-smoothing: antialiased; /* Makes fonts look crisper */
  }
  ...
  /* --- NEW PROFESSIONAL UTILITY CLASSES --- */
